...
| Visualization | D3.js | All rendering, bindingd, interaction |
...
- LATCH*GRAPH Spec: `/specs/LATCH-GRAPH-FILTERNAV-SPECIFICATION.md`
- DSL Plan: `/specs/dsl/DSL_IMPLEMENTATION_PLAN.md`
...
- Jest for unit tests
- Playwright for E2E (WebKit only for Safari coverage)
- 80% coverage threshold
- Test D3 bindings with jsdom + mock SVG
...
1. Add column to SQLite schema
2. Update Card component display
3. Add to Facet Selector options
4. Add DSL filter support
