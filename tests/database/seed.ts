...
const WORDS = [
  ...
  'component', 'module', 'service', 'layer', 'abstraction', 'protocol',
  'integration', 'workflow', 'pipeline', 'transformation', 'validation',
  'authentication', 'authorization', 'security', 'network', 'storage',
  'cache', 'index', 'schema', 'migration', 'transaction', 'replication',
  'synchronization', 'monitoring', 'logging', 'metrics', 'dashboard',
  'visualization', 'rendering', 'layout', 'navigation', 'interaction',
  'collaboration', 'document', 'annotation', 'reference', 'citation',
  'research', 'review', 'report', 'summary', 'overview', 'detail',
  'feature', 'requirement', 'specification', 'constraint', 'dependency',
  'version', 'release', 'deployment', 'rollback', 'migration', 'upgrade',
  'configuration', 'environment', 'variable', 'parameter', 'argument',
  'function', 'method', 'class', 'interface', 'type', 'generic',
  'async', 'await', 'promise', 'callback', 'event', 'listener',
  'state', 'mutation', 'action', 'reducer', 'selector', 'subscription',
  'provider', 'consumer', 'context', 'hook', 'effect', 'memo',
  'filter', 'sort', 'group', 'aggregate', 'join', 'union',
  'projection', 'selection', 'insertion', 'deletion', 'update',
] as const;
