...
// ---------------------------------------------------------------------------
import { uint8ArrayToBase64, base64ToUint8Array, extractChangeset, handleNativeSync } from '../src/native/NativeBridge';
      ...
      records: [
        {
          ...
          recordId: 'conn-1',
          operation: 'save',
          fields: { source_id: 'card-1', target_id: 'card-2', label: 'test', weight: 1.0, via_card_id: null, created_at: '2026-01-01T00:00:00Z' },
        },
        {
          recordType: 'Card',
          recordId: 'card-1',
          operation: 'save',
          fields: { name: 'Card 1', card_type: 'note', created_at: '2026-01-01T00:00:00Z', modified_at: '2026-01-01T00:00:00Z' },
        },
      ],
    };
    ...
    const payload = {
      records: [
        ...
        },
        {
          ...
          recordId: 'card-2',
          operation: 'save',
          fields: { name: 'Card 2', card_type: 'note', created_at: '2026-01-01T00:00:00Z', modified_at: '2026-01-01T00:00:00Z' },
        },
      ],
    };
      ...
      records: [
        {
          ...
          recordId: 'conn-1',
          operation: 'save',
          fields: { source_id: 'missing-card', target_id: 'card-2', label: '', weight: 1.0, via_card_id: null, created_at: '2026-01-01T00:00:00Z' },
        },
      ],
    };
