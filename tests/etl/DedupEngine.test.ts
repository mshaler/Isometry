...
describe('DedupEngine', () => {
	...
	describe('card classification', () => {
		it('classifies new cards as insert', () => {
			const cards: CanonicalCard[] = [createCard('note-1', 'New Note', '2026-03-01T12:00:00Z')];
		...
		it('classifies existing cards with newer timestamp as update', () => {
         ...
         VALUES (?, ?, ?, ?, ?, ?, ?, ?)`,
			...
			const cards: CanonicalCard[] = [createCard('note-1', 'New Version', '2026-03-01T12:00:00Z')];
		...
		it('classifies existing cards with same timestamp as skip', () => {
         ...
         VALUES (?, ?, ?, ?, ?, ?, ?, ?)`,
			...
			const cards: CanonicalCard[] = [createCard('note-1', 'Same Version', timestamp)];
		...
		it('classifies existing cards with older timestamp as skip', () => {
         ...
         VALUES (?, ?, ?, ?, ?, ?, ?, ?)`,
			...
			const cards: CanonicalCard[] = [createCard('note-1', 'Older Version', '2026-03-01T12:00:00Z')];
	...
	describe('sourceIdMap building', () => {
		it('builds sourceIdMap for new cards', () => {
			...
			const cards: CanonicalCard[] = [{ ...createCard('note-1', 'New Note', '2026-03-01T12:00:00Z'), id: cardId }];
		...
		it('builds sourceIdMap for existing cards', () => {
         ...
         VALUES (?, ?, ?, ?, ?, ?, ?, ?)`,
			...
			const cards: CanonicalCard[] = [createCard('note-1', 'Same Note', '2026-03-01T10:00:00Z')];
	...
	describe('connection resolution', () => {
		...
		it('drops connections with unresolvable source', () => {
			const cards: CanonicalCard[] = [{ ...createCard('note-1', 'Note 1', '2026-03-01T12:00:00Z'), id: 'uuid-1' }];
	...
	describe('deleted card detection', () => {
		...
		it('does NOT include cards from different source types in deletedIds', () => {
         ...
         VALUES (?, ?, ?, ?, ?, ?, ?, ?)`,
			...
			const cards: CanonicalCard[] = [createCard('note-1', 'Apple Note', '2026-03-01T10:00:00Z')];
		...
		it('does NOT include already soft-deleted cards in deletedIds', () => {
         ...
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`,
			...
			const cards: CanonicalCard[] = [createCard('note-1', 'Active Note', '2026-03-01T10:00:00Z')];
		...
		it('returns empty deletedIds when all existing cards are in incoming set', () => {
         ...
         VALUES (?, ?, ?, ?, ?, ?, ?, ?)`,
			...
			const cards: CanonicalCard[] = [createCard('note-1', 'Note 1', '2026-03-01T10:00:00Z')];
		...
		it('returns empty deletedIds when no existing cards for source type', () => {
			const cards: CanonicalCard[] = [createCard('note-1', 'New Note', '2026-03-01T10:00:00Z')];
	...
	describe('SQL injection safety', () => {
		it('handles malicious source_id safely via parameterized query', () => {
			...
			const cards: CanonicalCard[] = [{ ...createCard(maliciousSourceId, 'Malicious Note', '2026-03-01T12:00:00Z') }];
