...
public actor RegressionTestSuite {
    ...
    public func addKnownGoodDataset(
        ...
        print("📊 Added known-good dataset: \(name)")
    ...
    public func runRegressionTests<T: ImportTestHarness.ImporterProtocol>(
        ...
        print("🔍 Running regression tests for \(importer.importerName)")
        ...
        for (index, dataset) in filteredDatasets.enumerated() {
            do {
                ...
                if result.indicatesRegression {
                    print("   ⚠️ Regression detected in dataset: \(dataset.name)")
                ...
                print("   ❌ Test failed for dataset \(dataset.name): \(error)")
        ...
        print("✅ Regression test completed for \(importer.importerName)")
    ...
    public func runAllRegressionTests(
        ...
        print("✅ Comprehensive regression test suite completed")
        ...
        if totalRegressions == 0 {
            ...
            print("   🚨 \(totalRegressions) regressions require attention")
        }
...
public actor FileSystemTestDataRepository: RegressionTestSuite.TestDataRepository {
    ...
    private func addGitLFSTracking(for fileURL: URL) async throws {
        ...
        print("📦 Would add Git LFS tracking for: \(fileURL.lastPathComponent)")
    }
}
