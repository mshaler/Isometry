...
async function main(): Promise<void> {
	...
	// 11. Ribbon navigation — mounts into SuperWidget's ribbon slot
	...
	coordinator.subscribe(() => {
		// coordinator subscription kept for future wiring
	});

	// 11a. Wire ViewManager to update zoom rail visibility and ribbon active state on view switch.
