...
- [x] **Phase 129: Other Views + Cross-View UX** - Fix List/Grid/Kanban/Calendar/Gallery/Tree rendering via ViewManager; fix view switching and per-view empty states (completed 2026-03-27)
