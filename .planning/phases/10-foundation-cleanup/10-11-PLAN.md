...
must_haves:
  truths:
    ...
    - "D3 demo components have proper type safety"
    - "Crypto API BufferSource types resolved"
    - "Office document processor uses consistent type assignments"
  artifacts:
...
<task type="auto">
  ...
  <verify>npx tsc --noEmit --strict | grep -E "(demo|D3)" | wc -l returns 0</verify>
...
<task type="auto">
  ...
  <verify>npx tsc --noEmit --strict completes with exit code 0 (no errors)</verify>
