...
must_haves:
  truths:
    ...
    - "Animations use GPU-accelerated transforms (not width/height)"
  artifacts:
...
5. Verify FPS:
   ...
   - During animations, FPS should stay at 55+
  </how-to-verify>
...
4. FPS monitor shows 30+ fps during scroll, 55+ during animations
...
5. FPS stays at 55+ during animations (UX-02)
