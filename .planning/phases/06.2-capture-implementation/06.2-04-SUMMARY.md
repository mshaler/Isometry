...
1. **Task 1: SlashCommandManager** - `5e8f244` (feat)
2. **Task 2: SlashCommandMenu** - `c81f14f` (feat)
3. **Task 3: MarkdownEditor integration** - `9bfe15b` (feat)
4. **Task 4: NotebookEditorModel integration** - `a3cf59e` (feat)
