...
3. Test cases for `buildStackedHeaderQuery`:
...
4. Snapshot tests (optional but recommended):
...
Run: `npm run test -- src/db/queries/__tests__/header-discovery.test.ts`
  ...
  <done>All unit tests pass covering year, quarter, month, week, tags, and simple facets</done>
</task>
