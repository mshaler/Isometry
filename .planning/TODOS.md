...
- [ ] **App Store Connect setup + TestFlight** — Create app listing, archive & upload build, configure StoreKit products in App Store Connect, set up TestFlight beta testing. Return to this after data flows, UI/UX, and polish are validated on-device. (Captured: 2026-03-25, Source: Phase 121 device validation)
