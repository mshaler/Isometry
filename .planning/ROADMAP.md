...
- [x] **Phase 176: Explorer Sidecar + Status Slots** - Auto-show/hide sidecar transitions and rich contextual status per canvas type (completed 2026-04-22)

Plans:
- [x] 176-01-PLAN.md — Sidecar grid column + CSS transition + explorer panel rewire from passthrough to sidecar
- [x] 176-02-PLAN.md — Status clearing in commitProjection + sync indicator + per-canvas status bars
...
- [x] 178-02-PLAN.md — Sweep remaining 17 CSS files + 3 TS workarounds + regression check
...
| 178. CSS & Code Hygiene Audit | v13.3 | 2/2 | Complete    | 2026-04-22 |
