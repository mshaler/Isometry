...
- ✅ **v15.0 Formulas Explorer Architecture** - Phases 182-188 (shipped 2026-04-28) — [archive](milestones/v15.0-ROADMAP.md)

## Phases

<details>
<summary>Phases 1-188 -- archived milestones (see .planning/milestones/)</summary>

All phases 1-188 are archived in `.planning/milestones/` under their respective milestone directories.
