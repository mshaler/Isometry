...
Plans:
- [x] 100-01-PLAN.md — Settings service with CRUD and React hook (Wave 1) ✓
- [x] 100-02-PLAN.md — Facet discovery queries with TanStack Query caching (Wave 1) ✓

**Success Criteria:** ALL MET
1. ✓ Settings table exists and CRUD operations work (16 tests)
2. ✓ Facet discovery queries return distinct values from actual data (21 tests)
...
Plans:
- [x] 87-01-PLAN.md — GSD file parser with gray-matter frontmatter extraction (Wave 1)
- [x] 87-02-PLAN.md — Chokidar file watcher with debounced events (Wave 1)
- [x] 87-03-PLAN.md — Bidirectional sync service and ClaudeCodeServer integration (Wave 2)
