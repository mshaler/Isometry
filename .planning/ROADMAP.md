...
- [x] **Phase 112: File-Based Format E2E** - All 6 parsers through ImportOrchestrator to sql.js, malformed input recovery, export round-trip, and cross-format dedup collision detection (completed 2026-03-24)
...
- [x] **Phase 117: NetworkView Enhancement** - Full-replacement visual encoding (centrality/community), path/MST edge highlighting, floating legend panel, and two-click source/target picker (completed 2026-03-24)
...
Plans:
- [x] 116-01-PLAN.md — SchemaProvider graph metric injection, SuperGridQuery LEFT JOIN, filtered graph:compute (TDD)
