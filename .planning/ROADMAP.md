...
**Goal**: Fix all runtime correctness bugs and process gaps identified by Codex code review -- every shipped feature works correctly in real browsers, lint gate holds, and planning docs are accurate
**Depends on**: Nothing (first and only phase of v4.3)
**Requirements**: RFIX-01, RFIX-02, RFIX-03, BFIX-01, DFIX-01
**Success Criteria** (what must be TRUE):
  1. User can import .xlsx/.xls files via web file picker and see cards rendered correctly (ArrayBuffer path end-to-end)
  2. User can press ? on a US-layout keyboard (Shift+/) to toggle the help overlay in any real browser (shiftKey matching fixed)
...
Plans:
- [ ] 48-01-PLAN.md -- Excel ArrayBuffer fix, ? shortcut shift fix, undo/redo toast wiring, Biome lint cleanup, planning doc reconciliation

## Progress

**Execution Order:**
Phases execute in numeric order. Phases 1-47 complete across 10 milestones. Phase 48 is v4.3 Review Fixes.

| Phase | Milestone | Plans Complete | Status | Completed |
|-------|-----------|----------------|--------|-----------|
| 1-47 | v0.1-v4.2 | 143/143 | Complete | 2026-02-28 to 2026-03-07 |
| 48. Review Fixes | v4.3 | 0/1 | Pending | - |
...
*v4.3 Review Fixes roadmap created: 2026-03-07*
